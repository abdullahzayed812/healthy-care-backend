...
('a17', 2, 5, '14:00', '14:30', TRUE, FALSE, NOW(), NOW()),

('a18', 3, 1, '09:00', '09:30', TRUE, FALSE, NOW(), NOW()),
('a19', 3, 2, '10:00', '10:30', TRUE, FALSE, NOW(), NOW()),
...
('a31', 5, 4, '13:00', '13:30', TRUE, FALSE, NOW(), NOW()),
...
-- Mixed extra slots, also with 30-min duration
('a38', 2, 2, '15:00', '15:30', TRUE, FALSE, NOW(), NOW()),
('a39', 3, 3, '16:00', '16:30', TRUE, FALSE, NOW(), NOW()),
('a40', 4, 4, '08:00', '08:30', TRUE, FALSE, NOW(), NOW()),
('a41', 5, 5, '09:00', '09:30', TRUE, FALSE, NOW(), NOW()),
('a42', 6, 1, '10:00', '10:30', TRUE, FALSE, NOW(), NOW());
