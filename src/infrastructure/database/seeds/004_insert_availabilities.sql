...
('a17', 2, 5, '14:00', '14:30', TRUE, FALSE, NOW(), NOW()),  -- matched with appointment
('a38', 2, 2, '15:00', '15:30', TRUE, FALSE, NOW(), NOW()),  -- matched with appointment

-- Dr. Jones (id: 3)
('a18', 3, 1, '09:00', '09:30', TRUE, FALSE, NOW(), NOW()),
('a19', 3, 2, '10:00', '10:30', TRUE, FALSE, NOW(), NOW()),  -- matched
...
('a42', 6, 1, '10:00', '10:30', TRUE, FALSE, NOW(), NOW());  -- matched
